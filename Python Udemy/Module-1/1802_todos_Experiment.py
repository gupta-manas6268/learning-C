# Modified from '1801_todos.py', with using Images as Buttons.
...
# if not os.path.exists("1701_todos.txt"):  # If '1701_todos.txt', then '1701_todos.txt'
#     with open("1701_todos.txt", 'w') as file: # will be generated by 'os' module.
#         pass
...
add_button = sg.Button(size=(100, 20), image_source="1802_add.png", mouseover_colors="LightBlue2",
                       tooltip="Add Todo", key="Add") # 'size' isn't affecting because it depends on image dimension.

list_Box = sg.Listbox(values=functions_1701.get_todos(), 
                      key='todos_List', enable_events=True,
                      size=[45, 10])
edit_button = sg.Button("Edit")
delete_button = sg.Button(size=200, image_source="1802_delete.png", mouseover_colors="LightBlue2",
                       tooltip="Delet ToDo", key="Delete") # 'size' isn't affecting because it depends on image dimension.
